        ...
        <div class="col-12">
            {{-- <div class="tabtab bg-white rounded mb-4" id="contentkanan"> --}}
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="detail-tab" data-bs-toggle="tab" data-bs-target="#detail" type="button" role="tab" aria-controls="detail" aria-selected="true">Ujian</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active text-dark" id="listSiswa" role="tabpanel" aria-labelledby="listSiswa-tab">@include('detailKelas.listSiswa')</div>
                    <div class="tab-pane fade text-dark" id="detail" role="tabpanel" aria-labelledby="detail-tab">@include('detailKelas.detail')</div>
